...
export default function Dashboard() {
  ...
  // Derive stats for the dynamic right sidebar based on the selected coin
    ...
    <div className="min-h-screen bg-[#020617] text-slate-200 p-4 font-sans flex flex-col gap-4">
      ...
      <main className="max-w-[1800px] w-full mx-auto grid grid-cols-1 lg:grid-cols-12 gap-6 grow overflow-hidden">
        ...
        <div className="lg:col-span-2 flex flex-col h-full min-h-0 gap-6">
          ...
          {/* Capital Allocation Card (Moved to TOP) */}
          ...
          <div className="flex flex-col flex-grow min-h-0">
            <div className="text-[10px] font-black uppercase text-slate-500 mb-3 px-2 tracking-widest flex-shrink-0 flex items-center gap-2"><Target size={12}/> Market Scanners</div>
          ...
          <div className="bg-slate-900/50 border border-white/10 rounded-[2.5rem] p-6 shadow-2xl flex-shrink-0">
            ...
            <div className="flex flex-col gap-3">
              ...
              {currentAssetStrategies.map(strat => {
                // Dynamically calculate this specific strategy's performance
                const stratLogs = tradeLogs; // In v2, filter by strat.strategy if added to trade_logs
