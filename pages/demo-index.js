    ...
    <div className="min-h-screen bg-slate-950 text-slate-50 font-sans selection:bg-cyan-500/30">
      ...
      {content.testimonials && content.testimonials.length > 0 && (
        <div className="py-24 relative overflow-hidden">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div className="text-center mb-16">
              <span className="text-[11px] font-black uppercase tracking-[0.3em] text-indigo-400">Social Proof</span>
              <h2 className="text-4xl font-extrabold mt-3 mb-4 text-white">Trusted by Real Traders</h2>
              <p className="text-slate-400 max-w-2xl mx-auto">Real accounts. Real PnL. No fake testimonials.</p>
            </div>

            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              {content.testimonials.map((t, i) => (
                <div key={i} className="bg-slate-900/60 backdrop-blur-md border border-white/5 p-8 rounded-2xl flex flex-col relative group hover:border-indigo-500/50 transition-all duration-300">
                  ...
                  {/* Real PnL Badge */}
                  <div className="bg-emerald-500/10 border border-emerald-500/30 rounded-lg px-4 py-2 mb-6 text-center">
                    <span className="text-emerald-400 font-bold text-lg font-mono">
                      +${(t.total_pnl || 0).toLocaleString()}
                    </span>
                    <span className="text-emerald-400/60 text-xs ml-2">
                      across {t.closed_trades || 0} closed trades
                    </span>
                  </div>
                  ...
                  <div className="flex items-center gap-3 pt-4 border-t border-white/5">
                    ...
                    <div>
                      ...
                      <p className="text-indigo-400 text-[10px] font-black uppercase tracking-widest">{t.plan}</p>
                    </div>
                  </div>
                </div>
              ))}
            ...
            <div className="text-center mt-12">
              <Link href="/auth" className="inline-block bg-gradient-to-r from-indigo-500 to-purple-600 text-white px-8 py-4 rounded-full font-bold text-lg transition-all duration-300 hover:-translate-y-0.5 hover:shadow-[0_0_20px_rgba(99,102,241,0.5)]">
