    ...
    <div className="flex min-h-screen bg-slate-950 items-center justify-center p-6">
      ...
      <div className="w-full max-w-md space-y-8 bg-slate-900/50 border border-white/5 p-8 rounded-2xl backdrop-blur-xl">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          ...
          <button onClick={() => handleSocialLogin('discord')} className="flex items-center justify-center gap-2 bg-slate-950 border border-white/5 hover:bg-slate-900 py-3 rounded-xl transition-colors">
            ...
            <span className="text-xs font-bold text-white uppercase">Discord</span>
          </button>
        </div>
