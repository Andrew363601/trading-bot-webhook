...
const INDICATOR_REGISTRY = {
    ...
    exchange_balance_trend:     { kind: 'pane',    loader: () => import('../../lib/coinglass_exchange_balance_trend_v4.js').then(m => m.coinglass_exchange_balance_trend_v4) },
    oi_weighted_funding:        { kind: 'pane',    loader: () => import('../../lib/coinglass_oi_weighted_funding_v4.js').then(m => m.coinglass_oi_weighted_funding_v4) },
    grayscale_holdings_premium: { kind: 'pane',    loader: () => import('../../lib/coinglass_grayscale_holdings_premium_v4.js').then(m => m.coinglass_grayscale_holdings_premium_v4) },
    options_exchange_oi_trend:  { kind: 'pane',    loader: () => import('../../lib/coinglass_options_exchange_oi_trend_v4.js').then(m => m.coinglass_options_exchange_oi_trend_v4) },
    options_exchange_volume_trend: { kind: 'pane', loader: () => import('../../lib/coinglass_options_exchange_volume_trend_v4.js').then(m => m.coinglass_options_exchange_volume_trend_v4) },
    options_strike_distribution: { kind: 'pane',   loader: () => import('../../lib/coinglass_options_strike_distribution_v4.js').then(m => m.coinglass_options_strike_distribution_v4) },
    options_max_pain_pin:       { kind: 'pane',    loader: () => import('../../lib/coinglass_options_max_pain_pin_v4.js').then(m => m.coinglass_options_max_pain_pin_v4) },
    option_vs_futures_leverage: { kind: 'pane',    loader: () => import('../../lib/coinglass_option_vs_futures_leverage_v4.js').then(m => m.coinglass_option_vs_futures_leverage_v4) },
    top_position_long_short:    { kind: 'pane',    loader: () => import('../../lib/coinglass_top_position_long_short_v4.js').then(m => m.coinglass_top_position_long_short_v4) },
    top_account_long_short:     { kind: 'pane',    loader: () => import('../../lib/coinglass_top_account_long_short_v4.js').then(m => m.coinglass_top_account_long_short_v4) },
    exchange_wallet_assets:     { kind: 'pane',    loader: () => import('../../lib/coinglass_exchange_wallet_assets_v4.js').then(m => m.coinglass_exchange_wallet_assets_v4) },
    exchange_balance_reserve:   { kind: 'pane',    loader: () => import('../../lib/coinglass_exchange_balance_reserve_v4.js').then(m => m.coinglass_exchange_balance_reserve_v4) },
    cumulative_funding_regime:  { kind: 'pane',    loader: () => import('../../lib/coinglass_cumulative_funding_regime_v4.js').then(m => m.coinglass_cumulative_funding_regime_v4) },
    cross_exchange_funding_spread: { kind: 'pane', loader: () => import('../../lib/coinglass_cross_exchange_funding_spread_v4.js').then(m => m.coinglass_cross_exchange_funding_spread_v4) },
    hyperliquid_whale_momentum: { kind: 'overlay', loader: () => import('../../lib/coinglass_hyperliquid_whale_momentum_v4.js').then(m => m.coinglass_hyperliquid_whale_momentum_v4) },
    large_limit_order_history:  { kind: 'overlay', loader: () => import('../../lib/coinglass_large_limit_order_history_v4.js').then(m => m.coinglass_large_limit_order_history_v4) },
    bitcoin_profitable_days:    { kind: 'pane',    loader: () => import('../../lib/coinglass_bitcoin_profitable_days_v4.js').then(m => m.coinglass_bitcoin_profitable_days_v4) },
    etf_net_flow_momentum:      { kind: 'pane',    loader: () => import('../../lib/coinglass_etf_net_flow_momentum_v4.js').then(m => m.coinglass_etf_net_flow_momentum_v4) },
    vol_weighted_funding:       { kind: 'pane',    loader: () => import('../../lib/coinglass_vol_weighted_funding_v4.js').then(m => m.coinglass_vol_weighted_funding_v4) },
    aggregated_liquidation_map: { kind: 'overlay', loader: () => import('../../lib/coinglass_aggregated_liquidation_map_v4.js').then(m => m.coinglass_aggregated_liquidation_map_v4) },
    aggregated_orderbook_depth: { kind: 'overlay', loader: () => import('../../lib/coinglass_aggregated_orderbook_depth_v4.js').then(m => m.coinglass_aggregated_orderbook_depth_v4) },
};
