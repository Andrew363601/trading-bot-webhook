...
async function fetchMicrostructure(asset, triggerCandles, macroCandles, apiKey, secret) {
    try {
        ...
        // 🟢 THE FIX: Re-calculate the ATR so the AI can use it for Stop Losses
        ...
        return { 
            indicators: { 
                ...
                current_atr: parseFloat(atr.toFixed(2)) // 🟢 RE-INJECTED ATR
            }, 
...
export async function getMarketStateMCP(args) {
    ...
    try {
        ...
        return {
            ...
            volatility_atr: { // 🟢 EXPOSED VOLATILITY TO THE AI
