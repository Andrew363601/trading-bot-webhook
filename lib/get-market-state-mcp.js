...
async function fetchCoinbaseData(asset, granularity, apiKey, secret) {
    try {
        ...
        const secondsPerCandle = granularity === 'ONE_HOUR' ? 3600 : 300;
...
export async function getMarketStateMCP(args) {
    ...
    try {
        ...
        // Give Hermes exactly what it needs to make a decision
        return {
            symbol: symbol,
