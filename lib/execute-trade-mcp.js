   ...
   if (!coinbaseProduct.includes('-')) {
    ...
    if (!isPaper) {
      ...
      if (isClosing) {
          ...
          // Stash bracket restoration metadata BEFORE we nuke them.
          closeContext = {
              tpPrice: parseFloat(openTrade.tp_price) || null,
              slPrice: parseFloat(openTrade.sl_price) || null,
              closingSide: openTrade.side === 'BUY' ? 'SELL' : 'BUY',
