export async function coinglass_oi_momentum_v4(symbol, n_minutes = 15, interval) {
    ...
    try {
        ...
        const res = await fetch(`https://open-api-v4.coinglass.com/api/futures/open-interest/history?symbol=${symbol}&exchange=Binance&interval=${intervalParam}&limit=168`, {
