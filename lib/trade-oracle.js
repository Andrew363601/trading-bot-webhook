...
export async function evaluateTradeIdea({ mode, asset, strategy, signal, currentPrice, candles, macroCandles = [], indicators = {}, derivativesData = {}, orderBook = {}, pnlPercent = 0, marketType = 'FUTURES', openTrade = null, recentHistory = [] }) {
    ...
    CRITICAL MANDATE: Review your recent history to optimize ROI. If you are taking consecutive losses due to market chop (whipsawing), you MUST INCREASE your conviction threshold and VETO weak signals. Do not force trades.
    `;
