    ...
    while (attempts < maxRetries) {
        try {
            ...
            if (!resp.ok) {
                ...
                // If it's a different error (like bad API key), throw immediately
            ...
            if (attempts >= maxRetries) {
                ...
                return mode === 'ENTRY' ? { action: 'VETO', reasoning: 'Oracle timeout due to severe API congestion.' } : { action: 'HOLD', reasoning: 'Oracle timeout.' };
            }
        }
    }
}