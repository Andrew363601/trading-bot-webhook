...
export async function getRegimeTransitions(asset, currentRegime) {
    ...
    try {
        ...
        // 🟢 regime-fix: bound to a 7-day window — asc+limit alone grabbed the
        // OLDEST 2,000 scans, anchoring the feed to stale early-September regimes.
        ...
        console.log(`[L4-TRANSITIONS] ${asset}: ${scans?.length ?? 0} scans since ${since}`);
