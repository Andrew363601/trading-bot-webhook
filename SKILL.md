...
* **Crypto Volatility Normalization:** Crypto requires wider breathing room. Call `get_atr_levels` and apply 3.0x - 4.0x ATR for your Stop Loss (SL) to prevent being whipsawed by localized noise and stop-hunts. Target TP at the next major HVN or 50% ATR front-run of the Macro POC. ROI ÷ Risk must normally be > 1.5.
